...
namespace {
    ...
    TEST(SeedLocation, MyPuzzleInput) {
        ASSERT_EQ(84470622, solution->part1(
            { 3082872446, 316680412, 2769223903, 74043323, 4131958457, 99539464, 109726392, 353536902, 619902767, 648714498, 3762874676, 148318192, 1545670780, 343889780, 4259893555, 6139816, 3980757676, 20172062, 2199623551, 196958359 },
            {
                {
