...
namespace {
    ...
    TEST(GearRatios, exampleScenario) {
        ...
        ASSERT_EQ(467835, solution->part2({
            "467..114..",
            "...*......",
            "..35..633.",
            "......#...",
    ...
    TEST(GearRatios, myPuzzle) {
        ...
        ASSERT_EQ(540212, solution->part1(input));
        ASSERT_EQ(87605697, solution->part2(input));
    }
}
